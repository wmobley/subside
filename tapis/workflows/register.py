...
REPO_ROOT = Path(__file__).resolve().parents[2]  # subside/ (this file is tapis/workflows/register.py)
APP_JSON_GLOB = "tapis/workflow_apps/*/app-*.json"
PIPELINE_GLOB = "tapis/workflows/pipelines/*.yaml"
